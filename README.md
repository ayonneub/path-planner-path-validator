...
Frame ID mismatches Sometimes the path and validator used different frameid values,
...
Choosing the right inflation If inflation is too small, the robot might pass too close to
...
and tries again.
Start/goal tolerances Strict tolerances at start and goal sometimes rejected otherwise
...
Discontinuities after smoothing/interpolation Post-processing can create a step
...
Replanning loops without improvement In some worlds, simply increasing inflation
...
Stale debug markers Old collision markers sometimes remained visible. We now clear
